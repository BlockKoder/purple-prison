...
export default defineAppConfig({
    ...
    titlePrefix: "PurplePrison",
    // The name of your store
    storeName: "PurplePrison Store",
    ...
    mainSiteUrl: "https://purpleprison.net",
    // A discord invite url (optional)
    discordUrl: "https://discord.gg/purpleprison",
    // A IP of your server which to display (optional)
    serverIp: "play.purpleprison.net",
